...
if ( ! function_exists( 'our_towns_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function our_towns_posted_on() {
		...
		$posted_on = sprintf(
			...
			esc_html_x( 'Posted on %s', 'post date', 'our-towns' ),
...
if ( ! function_exists( 'our_towns_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function our_towns_posted_by() {
		$byline = sprintf(
			/* translators: %s: post author. */
			esc_html_x( 'by %s', 'post author', 'our-towns' ),
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'our-towns' ),
						array(
							'span' => array(
								'class' => array(),
							),
		...
		edit_post_link(
			sprintf(
				wp_kses(
					...
					__( 'Edit <span class="screen-reader-text">%s</span>', 'our-towns' ),
					array(
						'span' => array(
							'class' => array(),
						),
